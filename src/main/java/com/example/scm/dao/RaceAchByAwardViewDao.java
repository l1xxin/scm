...
public interface RaceAchByAwardViewDao extends BaseMapper<RaceAchByAwardView> {
     ...
     *
     * @param entities List<RaceAchByAwardView> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<RaceAchByAwardView> entities);
     ...
     */
    int insertOrUpdateBatch(@Param("entities") List<RaceAchByAwardView> entities);
